...
public final class MagicClassification {
   private static final Map<String, MagicClassification.ManaCostType> MAGIC_COST_TYPES = Map.ofEntries(
      ...
      Map.entry("flame_array", MagicClassification.ManaCostType.SUSTAINED_OR_INDIRECT),
      Map.entry("azure_water_array", MagicClassification.ManaCostType.SUSTAINED_OR_INDIRECT),
      Map.entry("gale_wind_array", MagicClassification.ManaCostType.SUSTAINED_OR_INDIRECT),
      Map.entry("rock_earth_array", MagicClassification.ManaCostType.SUSTAINED_OR_INDIRECT),
      Map.entry("contract_magecraft", MagicClassification.ManaCostType.SUSTAINED_OR_INDIRECT),
      Map.entry("aerial_stasis", MagicClassification.ManaCostType.SUSTAINED_OR_INDIRECT),
