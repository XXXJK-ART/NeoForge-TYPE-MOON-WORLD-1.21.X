    ...
    public static void execute(Entity entity) {
        ...
        if (entity instanceof Player player) {
            ...
            if (count >= 3) {
                ...
                // Apply Buffs (Base 60s = 1200 ticks)
                int duration = Math.round(1200 * multiplier);

                if (player instanceof LivingEntity living) {
                    living.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, duration, 1)); // Strength II
                    living.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, duration, 1)); // Speed II
                    living.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, duration, 1)); // Resistance II
                    living.addEffect(new MobEffectInstance(MobEffects.JUMP, duration, 1)); // Jump Boost II (Bonus)
