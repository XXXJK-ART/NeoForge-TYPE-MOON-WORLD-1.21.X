    ...
    public static void execute(Entity entity) {
        ...
        if (index >= 0 && index < vars.selected_magics.size()) {
            ...
            if ("ruby_throw".equals(magicId)) {
                ...
                net.xxxjk.TYPE_MOON_WORLD.magic.jewel.MagicJewelMachineGun.execute(entity);
                castSuccess = true;
            }
            ...
            if (castSuccess) {
                ...
                if (vars.selected_magics.get(index).startsWith("jewel_magic_shoot")
                    ...
                    // Proficiency?
                    vars.proficiency_jewel_magic_release = Math.min(100, vars.proficiency_jewel_magic_release + 0.5); // Higher gain for advanced
                    vars.syncProficiency(entity);
