...
public final class ChainConfig {
    ...
    public static final int HIT_PART_COUNT = 16;
    public static final float HIT_PART_SIZE = 1.35F;
    public static final int RENDER_SEGMENT_CAP = 128;
    ...
    public static final int ENUMA_CLIENT_FIELD_PARTICLES_PER_TICK = 64;
