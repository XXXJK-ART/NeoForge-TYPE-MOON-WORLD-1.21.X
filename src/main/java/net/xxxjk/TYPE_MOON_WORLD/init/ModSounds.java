...
public final class ModSounds {
   ...
   public static final DeferredHolder<SoundEvent, SoundEvent> CURSED_ARM_HASSAN_VOICE_ATTACK = register("cursed_arm_hassan_voice_attack");
   ...
   public static final DeferredHolder<SoundEvent, SoundEvent> ENKIDU_VOICE_ATTACK = register("enkidu_voice_attack");
   public static final DeferredHolder<SoundEvent, SoundEvent> ENKIDU_VOICE_FAIL = register("enkidu_voice_fail");
