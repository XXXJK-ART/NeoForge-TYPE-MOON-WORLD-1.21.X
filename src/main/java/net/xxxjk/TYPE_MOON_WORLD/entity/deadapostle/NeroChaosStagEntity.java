...
public class NeroChaosStagEntity extends Goat implements NeroChaosBeastLogic.NeroChaosBeastEntityMarker {
   public NeroChaosStagEntity(EntityType<? extends Goat> type, Level level) {
      super(type, level);
