...
public class NeroChaosCatEntity extends Cat implements NeroChaosBeastLogic.NeroChaosBeastEntityMarker {
   public NeroChaosCatEntity(EntityType<? extends Cat> type, Level level) {
      super(type, level);
