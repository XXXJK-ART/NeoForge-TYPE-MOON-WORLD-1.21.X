...
public class NeroChaosHoundEntity extends Wolf implements NeroChaosBeastLogic.NeroChaosBeastEntityMarker {
   public NeroChaosHoundEntity(EntityType<? extends Wolf> type, Level level) {
      super(type, level);
   ...
   public static AttributeSupplier.Builder createAttributes() {
      return Mob.createMobAttributes()
         ...
         .add(Attributes.MOVEMENT_SPEED, 0.39)
