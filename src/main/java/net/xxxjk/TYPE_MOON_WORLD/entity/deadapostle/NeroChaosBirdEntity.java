...
public class NeroChaosBirdEntity extends Parrot implements NeroChaosBeastLogic.NeroChaosBeastEntityMarker {
   public NeroChaosBirdEntity(EntityType<? extends Parrot> type, Level level) {
      super(type, level);
