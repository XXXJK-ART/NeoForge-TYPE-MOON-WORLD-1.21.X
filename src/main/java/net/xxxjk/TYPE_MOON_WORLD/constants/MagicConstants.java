...
public class MagicConstants {
   ...
   public static final int RUBY_LIFETIME_TICKS = 200;
   ...
   public static final int SAPPHIRE_ICE_DURATION = 100;
   public static final int SAPPHIRE_DEBUFF_DURATION = 100;
   public static final int EMERALD_WALL_DURATION = 160;
   public static final int EMERALD_WALL_WIDTH = 3;
   public static final int EMERALD_WALL_HEIGHT = 3;
   public static final int EMERALD_WALL_DISTANCE = 4;
   public static final float TOPAZ_THROW_VELOCITY = 2.0F;
   public static final float TOPAZ_THROW_INACCURACY = 1.0F;
   public static final int TOPAZ_DEBUFF_DURATION = 200;
   public static final double TOPAZ_EFFECT_RADIUS = 5.0;
   public static final float CYAN_WIND_RADIUS = 4.0F;
   public static final int CYAN_WIND_DURATION = 100;
