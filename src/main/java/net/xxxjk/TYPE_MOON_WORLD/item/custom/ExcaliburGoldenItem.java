...
import net.xxxjk.TYPE_MOON_WORLD.client.renderer.ExcaliburGoldenRenderer;
...
public class ExcaliburGoldenItem extends SwordItem implements GeoItem, NoblePhantasmItem {
   ...
   public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
      consumer.accept(new GeoRenderProvider() {
         private ExcaliburGoldenRenderer renderer;

         public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
            if (this.renderer == null) {
               this.renderer = new ExcaliburGoldenRenderer();
            }
   ...
   public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
      ...
      tooltip.add(Component.translatable("item.typemoonworld.excalibur2.desc").withStyle(ChatFormatting.GOLD));
   }
