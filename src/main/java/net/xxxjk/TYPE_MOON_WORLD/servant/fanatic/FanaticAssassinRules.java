...
public final class FanaticAssassinRules {
   ...
   public static final float MARROW_DAMAGE = 80.0F;
   public static final double HAIR_RANGE = 8.0;
   public static final float HAIR_DAMAGE = 60.0F;
   ...
   public static final float TOXIN_DAMAGE_PER_SECOND = 6.0F;
   public static final int JINN_MAX_HEALTH = 200;
   public static final float JINN_DAMAGE = 15.0F;

   public static final int HEARTBEAT_MP = 25;
   public static final int MARROW_MP = 20;
   public static final int HAIR_MP = 15;
   public static final int TEMPERATURE_MP = 15;
   public static final int NERVES_MP = 10;
   public static final int COMPUTER_MP = 20;
   public static final int TOXIN_MP = 15;
   public static final int JINN_MP = 30;

   public static final int HEARTBEAT_COOLDOWN = 400;
   public static final int MARROW_COOLDOWN = 300;
   public static final int HAIR_COOLDOWN = 240;
   public static final int TEMPERATURE_COOLDOWN = 360;
   public static final int NERVES_COOLDOWN = 400;
   public static final int COMPUTER_COOLDOWN = 500;
   public static final int TOXIN_COOLDOWN = 400;
   public static final int JINN_COOLDOWN = 800;
   ...
   public static float heartbeatDamage(StatRank magic, StatRank luck) {
      return isAtLeastB(magic) || isAtLeastB(luck) ? HEARTBEAT_DAMAGE * 0.5F : HEARTBEAT_DAMAGE;
   }
