...
import net.xxxjk.TYPE_MOON_WORLD.chain.client.renderer.HeavenChainRenderer;
...
public class TypeMoonWorldClientEvents {
   ...
   public static void registerRenderers(RegisterRenderers event) {
      ...
      event.registerEntityRenderer(ModEntities.OKITA_SHINSENGUMI.get(), OkitaShinsengumiRenderer::new);
      ...
      event.registerEntityRenderer(ModEntities.EMIYA_ARCHER.get(), context -> new HumanoidServantRenderer<>(context, "emiya_archer"));
      event.registerEntityRenderer(ModEntities.SENKO_MURAMASA.get(), context -> new HumanoidServantRenderer<>(context, "senko_muramasa"));
      event.registerEntityRenderer(ModEntities.ARASH.get(), context -> new HumanoidServantRenderer<>(context, "arash"));
      ...
      event.registerEntityRenderer(ModEntities.ARTORIA_PENDRAGON.get(), context -> new HumanoidServantRenderer<>(context, "artoria_pendragon"));
      ...
      event.registerEntityRenderer(ModEntities.HEAVEN_CHAIN.get(), HeavenChainRenderer::new);
      event.registerEntityRenderer(ModEntities.HEAVEN_CHAIN_BINDING.get(), HeavenChainBindingRenderer::new);
      event.registerEntityRenderer(ModEntities.ENUMA_CHAIN_CROWN.get(), EnumaChainCrownRenderer::new);
