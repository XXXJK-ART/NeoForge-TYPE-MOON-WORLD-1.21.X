...
import net.xxxjk.TYPE_MOON_WORLD.client.model.ServantModel;
...
public class ServantRenderer extends GeoEntityRenderer<ServantEntity> {
   public ServantRenderer(Context renderManager) {
      super(renderManager, new ServantModel());
      this.withScale(1.2F);
      this.addRenderLayer(
         new BlockAndItemGeoLayer<ServantEntity>(this) {
            @Override
            ...
            protected void renderStackForBone(
               ...
               GeoBone bone,
               ItemStack stack,
               ServantEntity animatable,
               MultiBufferSource bufferSource,
               float partialTick,
               int packedLight,
               int packedOverlay
            ) {
               poseStack.translate(0.15F, -0.8F, 0.01F);
