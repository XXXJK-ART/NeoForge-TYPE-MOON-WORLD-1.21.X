...
public class BrokenPhantasmRenderer extends EntityRenderer<BrokenPhantasmProjectileEntity> {
   public BrokenPhantasmRenderer(Context context) {
      super(context);
   }

   public void render(
      BrokenPhantasmProjectileEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight
   ) {
      poseStack.pushPose();
      float scale = 1.75F;
