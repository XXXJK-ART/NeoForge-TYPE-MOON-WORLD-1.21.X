...
import net.xxxjk.TYPE_MOON_WORLD.client.model.KendoPlayerModel;
...
public class KendoApprenticeRenderer extends HumanoidMobRenderer<KendoApprenticeEntity, PlayerModel<KendoApprenticeEntity>> {
   ...
   public KendoApprenticeRenderer(EntityRendererProvider.Context context) { super(context, new KendoPlayerModel<>(context.bakeLayer(ModelLayers.PLAYER), false), 0.5F); male = getModel(); female = new KendoPlayerModel<>(context.bakeLayer(ModelLayers.PLAYER_SLIM), true); }
