...
final class BlackShadowOutlineLayer extends RenderLayer<SakuraBlackShadowEntity, BlackShadowModel> {
    ...
    BlackShadowOutlineLayer(RenderLayerParent<SakuraBlackShadowEntity, BlackShadowModel> parent, EntityModelSet modelSet) {
        super(parent);
