...
public final class BlackShadowRenderer extends MobRenderer<SakuraBlackShadowEntity, BlackShadowModel> {
    ...
    @Override
    public ResourceLocation getTextureLocation(SakuraBlackShadowEntity entity) {
        return TEXTURE;
    }

    @Override
    public void render(
        SakuraBlackShadowEntity entity,
        float entityYaw,
        float partialTick,
        PoseStack poseStack,
        ...
        float elapsed = SakuraBlackShadowEntity.MAGIC_OUTPUT_CHARGE_TICKS - chargeTicks + partialTick;
    ...
    @Override
    protected float getFlipDegrees(SakuraBlackShadowEntity entity) {
        return 0.0F;
    }
}
