...
public final class BlackShadowModel extends HierarchicalModel<SakuraBlackShadowEntity> {
    ...
    public void setupAnim(
        ...
        float movement = entity.getAction() == SakuraBlackShadowEntity.ACTION_WALK
