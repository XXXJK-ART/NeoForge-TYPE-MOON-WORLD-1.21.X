...
public final class ShadowFamiliarOutlineModel extends HierarchicalModel<ShadowFamiliarEntity> {
    ...
    @Override
    public void setupAnim(ShadowFamiliarEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (attackPhase == ShadowFamiliarEntity.ATTACK_PHASE_SHADOW_BINDING) {
        ...
        } else if (attackPhase == ShadowFamiliarEntity.ATTACK_PHASE_VOID_ABSORPTION) {
