...
| 闪避 | 闪避数值只由敏捷等级决定；敏捷越高越容易自动闪避。闪避消耗 MP，并给予短暂无敌。低血量、弹射物、决胜阶段会更积极闪避。 |
| 格挡和弹反 | 防御数值由筋力等级决定；筋力越高格挡减伤和防御资源上限越高。及时格挡可能弹反，完全抵消伤害并短暂眩晕攻击者。体力耗尽会进入破防疲劳。 |
| 体力 | 格挡消耗体力；各等级体力回复速度相同，特殊技能可以额外加速或减速。不要让角色所有技能都只看 MP，近战角色也要考虑体力压力。 |
| 韧度 | 韧度数值只由耐久等级决定。大伤害、控制和击飞会消耗韧度，韧度归零会破防眩晕；各等级韧度回复速度相同，特殊技能可以额外调整。 |
...
| 属性 | 主要影响 |
| --- | --- |
| 敏捷 | 战斗移动速度、闪避概率、闪避冷却、闪避无敌时间、闪避 MP 消耗。 |
| 耐久 | 韧度上限、破防眩晕时长。 |
| 力量 | 防御/护甲、格挡减伤、体力上限、击飞距离、击飞命中硬直、击飞消耗。 |
| 魔力 | 技能压制和部分特殊反应。 |
